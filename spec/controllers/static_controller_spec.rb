...
describe StaticController do
  ...
  describe "GET index" do
    it "assigns all statics as @products and creates an order stored in session[:order_id]" do
  ...
  #       post :create, {:static => { "index" => "invalid value" }}, valid_session
  #       assigns(:static).should be_a_new(Static)
  #     end
  ...
  #       Static.any_instance.should_receive(:update).with({ "index" => "MyString" })
  #       put :update, {:id => static.to_param, :static => { "index" => "MyString" }}, valid_session
  #     end
  ...
  #       # Trigger the behavior that occurs when invalid params are submitted
  #       Static.any_instance.stub(:save).and_return(false)
  #       put :update, {:id => static.to_param, :static => { "index" => "invalid value" }}, valid_session
  #       assigns(:static).should eq(static)
  #     end
